package java.javaDatabase;
import java.Classes.AbsStudent;
import java.Classes.CombinedStudy;
import java.Classes.HumanitarianStudy;
import java.Classes.TechnicalStudy;
